...
LABEL org.opencontainers.image.description="Real-time US-equity quotes, company fundamentals, earnings, analyst trends, and news via Finnhub."
LABEL org.opencontainers.image.licenses="Apache-2.0"
LABEL org.opencontainers.image.version="${APP_VERSION}"
LABEL org.opencontainers.image.source="https://github.com/cyanheads/finnhub-mcp-server"
...
RUN mkdir -p /var/log/finnhub-mcp-server && chown -R bun:bun /var/log/finnhub-mcp-server
...
ENV LOGS_DIR="/var/log/finnhub-mcp-server"
